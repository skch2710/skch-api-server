...
import com.skch.skch_api_server.util.CacheDataService;
...
//		retryUtil.getRetry();
		Map<String, String> dataFromCache = cacheDataService.getDataFromCache(resource);
		return ResponseEntity.ok(dataFromCache);
	}
